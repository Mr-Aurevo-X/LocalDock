...
ALLOW_RE='http://127\.0\.0\.1|http://localhost|https://github\.com/Mr-Aurevo-X|https://discord\.com/users/406891052516114442|https://www\.paypal\.com/paypalme/aurevo1|https://revolut\.me/mr_aurevo_x'
url_failures=()
